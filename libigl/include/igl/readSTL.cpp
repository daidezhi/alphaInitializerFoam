...
#  define IGL_LINE_MAX 2048
  ...
  }else
  {
    ...
    V.resize(num_tri*3,std::vector<TypeV >(3,0));
    N.resize(num_tri,std::vector<TypeN >(3,0));
    F.resize(num_tri,std::vector<TypeF >(3,0));
